...
<br/>
<%
	String itemName=request.getParameter("uploadhidden");
	if(itemName != null){
		...
		String filename="/var/lib/tomcat7/webapps/ROOT/temp/" + randomFilename + "/" + itemName;
		//out.print(filename);
...
<p>&nbsp;</p>
<p>&nbsp;</p>
&nbsp;&nbsp;&nbsp;The sample you upload is "<%=itemName%>".
<p>&nbsp;</p>
