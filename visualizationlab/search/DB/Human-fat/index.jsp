...
<p style="width:900px; margin:20px 20px 20px 20px;">A core gut microbiome in obese and lean twins</p>
  <ul>
<br />
<form action="metastornonlieresult.jsp" method="get" name="form" style="padding-left:20px">
  <input type="radio" name="item" value="/mnt/gene/suxq/metablast/ftp/all/Human/fat-1/classification.txt" /> Human-fat-1
